				    	...
				    	<table class="table table-striped table-bordered table-hover">
				    		...
				    		<c:forEach items="${blogs}" var="blog">
				    			<tr id="item_${blog.id}">
				    				...
				    				<td><a href="/my/blog/edit?id=${blog.id}" title="编辑"><span class="glyphicon glyphicon-edit">编辑</span></a>&nbsp;&nbsp;
				    				<a href="#" onclick="removeBlog(${blog.id});" title="删除"><span class="glyphicon glyphicon-remove">删除</span></a></td>
				    			</tr>
				    		</c:forEach>
				    		</tbody>
				    	</table>
