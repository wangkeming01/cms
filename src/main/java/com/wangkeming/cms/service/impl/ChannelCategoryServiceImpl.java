...
import com.wangkeming.cms.dao.CategoryMapper;
import com.wangkeming.cms.dao.ChannelMapper;
...
public class ChannelCategoryServiceImpl implements ChannelCategoryService {
	...
	public void saveCategory(Category category) {
		Integer sorted = categoryMapper.queryMaxSorted(category.getChannel().getId());
		category.setSorted(sorted);
