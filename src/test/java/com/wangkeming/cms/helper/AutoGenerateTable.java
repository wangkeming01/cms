 ...
 * 
 */
package com.wangkeming.cms.helper;
...
import com.wangkeming.cms.domain.Settings;
...
public class AutoGenerateTable {
	...
	public static void initUsers(Session session){
		Transaction transaction = null;
		try {
			Query query = session.createQuery("select count(id) from com.wangkeming.cms.domain.User");
	...
	public static void initChannelAndCategory(Session session){
		Transaction transaction = null;
		try {
			Query query = session.createQuery("select count(id) from com.wangkeming.cms.domain.Channel");
			Long amount = (Long) query.uniqueResult();
			if(amount > 0){
				return;
			}
	...
	public static void initArticles(Session session){
		Transaction transaction = null;
		try {
			Query query = session.createQuery("select count(id) from com.wangkeming.cms.domain.Article");
			Long amount = (Long) query.uniqueResult();
			if(amount > 0){
				return;
			}

			query = session.createQuery("from com.wangkeming.cms.domain.User where username=?");
			...
			query = session.createQuery("from com.wangkeming.cms.domain.Channel where name=?");
			query.setParameter(0, "科技");
			Channel channel = (Channel)query.uniqueResult();
			
			query = session.createQuery("from com.wangkeming.cms.domain.Category where name=?");
	...
	public static void initSlide(Session session){
		Transaction transaction = null;
		try {
			Query query = session.createQuery("select count(id) from com.wangkeming.cms.domain.Slide");
			Long amount = (Long) query.uniqueResult();
			if(amount > 0){
				return;
			}
